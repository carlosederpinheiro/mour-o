...
import { Mail, Lock, ArrowRight, ShieldCheck, UserCircle2, Briefcase } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background pt-16 flex">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-primary flex-col justify-between overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1758518725921-1eb74ed293be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBjb3Jwb3JhdGUlMjBvZmZpY2UlMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzc4Njk2Mjc1fDA&ixlib=rb-4.1.0&q=80&w=1080"
        ...
        <div className="relative z-10 p-16 flex flex-col h-full justify-between">
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">
              Mourão <span className="text-accent">Consultoria</span>
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-accent text-primary font-bold py-4 rounded-xl hover:bg-primary hover:text-white transition-all duration-300 flex items-center justify-center gap-2 group shadow-lg shadow-accent/20"
            >
              Entrar no Portal
